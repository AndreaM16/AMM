            ...
            <div id="leftSidebar">
                ...
                <div style="margin-left:25px;margin-top:10px;">
                    ...
                    <?php 
                        ...
                        echo("<ul><li><p id='formHeader' style='margin-top:0px;'><a href='../homepage.php'>[VAI ALLA HOME]</a></p></li><li><p id='formHeader' style='margin-top:0px;'><a href='user.php'>[AGGIUNGI UTENTE]</a></p><li><p id='formHeader' style='margin-top:0px;'><a href='../common/order.php'>[AGGIUNGI ORDINE]</a></p></li>");
                    }
                    ?>
                </div>
            </div>
